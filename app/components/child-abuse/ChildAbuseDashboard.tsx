        ...
        <div className="max-w-7xl mx-auto p-6">
          ...
          <div className="mt-8 bg-red-100 border-2 border-red-300 rounded-lg p-6">
            ...
            <div className="text-center">
              <p className="text-lg text-red-700 mb-4">Call 1121 or tell a trusted adult right away</p>
              <div className="flex flex-wrap justify-center gap-4">
                <div className="bg-white rounded-lg p-4 shadow-md">
                  <h4 className="font-semibold text-red-800 mb-2">Child Abuse Hotline:1121</h4>
                  <p className="text-2xl font-bold text-red-600">0800-89457</p>
                ...
                <div className="bg-white rounded-lg p-4 shadow-md">
                  ...
                  <p className="text-2xl font-bold text-red-600">Text "SAFE" to +92311-7786264 </p>
