...
import OldAgeDashboard from "../../components/oldage/OldAgeDashboard";
import TherapyPlayerOldAge from "../../components/oldage/TherapyPlayerOldAge";

export default function OldAgePage() {
  ...
  return (
    <div className="min-h-screen bg-[#E6F7F1] font-sans">
      ...
      <main className="mx-auto p-6 md:px-10 md:py-8 grid grid-cols-1 gap-8 items-start">
        <div>
          <OldAgeDashboard onRecommend={(id) => setRecommendedId(id)} />
        </div>
        <div>
